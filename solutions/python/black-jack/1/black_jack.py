...
def higher_card(card_one, card_two):
    ...
    """
    num_card_one = value_of_card(card_one)
    num_card_two = value_of_card(card_two)
    if num_card_one > num_card_two:
        return str(num_card_one)
    elif num_card_two > num_card_one:
        return str(num_card_two)
    else:
...
def is_blackjack(card_one, card_two):
    ...
    if card_one == 'A' and card_two in {'J', 'Q', 'K'}:
        return True
    elif card_two == 'A' and card_one in {'J', 'Q', 'K'}:
        return True
    elif (num_card_one + num_card_two) == 21:
        return True
    else:
        return False
