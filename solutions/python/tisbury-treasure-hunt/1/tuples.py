...
def compare_records(azara_record, rui_record):
    ...
    """
    rui_record_coordinates_tuple = rui_record[1]
    rui_record_coordinates = rui_record_coordinates_tuple[0] + rui_record_coordinates_tuple[1]
    
    return rui_record_coordinates == azara_record[1]
...
def clean_up(combined_record_group):
    ...
    for record in combined_record_group:
        ...
        record_list.pop(1)
        cleaned_lines.append(str(tuple(record_list)))
